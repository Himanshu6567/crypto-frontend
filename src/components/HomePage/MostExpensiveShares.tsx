...
//   return (
//     <section id="expensive" className="py-16 text-white bg-gray-800">
...
//             <div
//               key={index}
//               className="overflow-hidden transition transform bg-gray-900 rounded-lg shadow-lg hover:-translate-y-1 hover:shadow-xl"
//             >
