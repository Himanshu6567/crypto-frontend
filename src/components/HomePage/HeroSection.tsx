...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen px-1 overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div
        className="absolute rounded-full bottom-20 right-10 w-96 h-96 bg-gradient-to-r from-purple-400 to-pink-500 opacity-20 blur-3xl animate-pulse"
      ...
      <div className="container relative z-10 px-4 py-20 mx-auto">
        <div className="flex flex-col items-center justify-between min-h-screen lg:flex-row">
          ...
          >
            ...
            <p className="max-w-lg text-xl leading-relaxed text-white/80">
              Harness the power of real-time data, AI-driven insights, and
              expert guidance to transform your stock portfolio into a
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <Link to={"/coins"}
                // size="lg"
                className="flex items-center justify-center px-8 py-4 text-lg font-semibold text-white transition-all duration-300 transform rounded-full shadow-xl bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 hover:shadow-emerald-500/25 hover:scale-105 group"
              >
                Get Started Today
            ...
            <div className="flex gap-8 pt-4">
              {stats.map((stat, index) => (
                <div key={index} className="text-center">
                  <div className="text-2xl font-bold lg:text-3xl text-emerald-400">
                    {stat.value}
                  </div>
          ...
          >
            ...
            <div className="relative">
              ...
              <div
                className="absolute w-16 h-16 rounded-full -bottom-4 -left-4 bg-gradient-to-r from-blue-400 to-purple-500 opacity-80 blur-xl animate-bounce"
                style={{ animationDelay: "1s" }}
              ></div>
            </div>
          </div>
        ...
        >
          ...
          <div className="flex items-center justify-center gap-8 opacity-50">
            <div className="flex items-center justify-center w-24 h-12 p-2 rounded bg-white/10 backdrop-blur-md">
            ...
            <div className="flex items-center justify-center w-24 h-12 p-2 rounded bg-white/10 backdrop-blur-md">
              <svg viewBox="0 0 200 60" className="w-full h-full fill-white">
                <circle cx="40" cy="30" r="8" className="fill-emerald-400" />
                <text
                  x="110"
                  y="35"
                  textAnchor="middle"
